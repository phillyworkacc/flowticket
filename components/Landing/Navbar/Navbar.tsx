...
import { CustomIcon, FlowTicketSvgLogoText } from "@/components/Icons/Icon"
         ...
         content: <>
            ...
            {session?.user ? <>
               <div className="text-xs bold-500 dfb align-center gap-7" onClick={() => {
                  ...
                  <CustomIcon url={userDefaultImage} size={30} round />
      ...
      <div className="navbar">
         <div className="navbar-container">
            ...
            <div className="branding" onClick={() => router.push('/')}>
               <div className="logo"><FlowTicketSvgLogoText size={20} /></div>
            </div>
            ...
            <div className="action">
               {session?.user ? <>
                  <div className="user-account-button" onClick={() => router.push('/account')}>
                     <CustomIcon url={userDefaultImage} size={40} round />
                  </div>
               </> : <>
